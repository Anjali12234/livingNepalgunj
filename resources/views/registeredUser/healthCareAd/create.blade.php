                ...
                <form class="mt-8" action="{{ route('registeredUser.healthCareList.store', $healthCareCategory) }}"
                    ...
                    <div class="block md:grid grid-cols-4 pr-16">
                        ...
                        <div class="col-span-2">
                            ...
                            <x-frontend.forms.input-type-field :value="old('youtube_link')" labelClass="w-36" label="YouTube Link" spanClass="text-white" id="youtube_link"
                                                               name="youtube_link" type="text" class="text-sm font-semibold" {{-- placeholder="Per Month" --}} />

                            <x-frontend.forms.text-area-component :value="old('map_url')" labelClass="w-36" label="Map Url" spanClass="text-white" id="map_url"
                                                                  name="map_url" type="text" class="text-sm font-semibold" {{-- placeholder="Per Month" --}} />
                            <x-frontend.forms.input-type-field :value="old('twitter_url')" labelClass="w-36" label="Twitter Url" spanClass="text-white" id="twitter_url"
                                                               name="twitter_url" type="text" class="text-sm font-semibold" {{-- placeholder="Per Month" --}} />
                            <x-frontend.forms.input-type-field :value="old('website_url')" labelClass="w-36" label="Website Url" spanClass="text-white" id="website_url"
                                                               name="website_url" type="text" class="text-sm font-semibold" {{-- placeholder="Per Month" --}} />


                            <x-frontend.forms.input-type-field :value="old('facebook_url')" labelClass="w-36" label="Facebook Url" spanClass="text-white" id="facebook_url"
                                                               name="facebook_url" type="text" class="text-sm font-semibold" />
                            <x-frontend.forms.input-type-field :value="old('whats_app_no')" labelClass="w-36" label="Whats App Number" id="whats_app_no"
                                                               name="whats_app_no" type="number" class="text-sm font-semibold" />

                            <x-frontend.forms.file-component label="Hospital Image" id="files"
                ...
                <form class="mt-8" action="{{ route('registeredUser.healthCareList.store', $healthCareCategory) }}"
                    ...
                    <div class="block md:grid grid-cols-4 pr-16">
                        ...
                        <div class="col-span-2">
                            ...
                            <x-frontend.forms.file-component label="Medical Image " id="files"
                                                             name="files[]" type="file" class="text-sm font-semibold" multiple="multiple"
                                {{-- placeholder="Per Month" --}} />
                        </div>
                        <div class="col-span-4">
                ...
                <form class="mt-8" action="{{ route('registeredUser.healthCareList.store', $healthCareCategory) }}"
                    ...
                    <div class="block md:grid grid-cols-4 pr-16">
                        ...
                        <div class="col-span-2">
                            ...
                            <x-frontend.forms.file-component label="Pharmacy Image" id="files"
                                                             name="files[]" type="file" class="text-sm font-semibold" multiple="multiple"
                                {{-- placeholder="Per Month" --}} />
                        </div>
                        <div class="col-span-4">
