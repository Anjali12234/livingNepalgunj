...
@section('content')
    <div class="content px-5  md:px-7 col-span-3 mt-8 md:mt-0 font-manrope min-h-screen">
            ...
            <nav class="flex gap-x-1 bg-neutral-800 rounded-md" aria-label="Tabs" role="tablist"
                ...
                @foreach ($mainCategories as $mainCategory)
                    ...
                    dark:text-neutral-400 dark:hover:text-blue-500"
                                ...
                                data-tab-content="#tab-content-{{ $healthCareCategory->id }}"
                                role="tab"
        ...
        <div class="mt-3">
            @foreach ($mainCategories as $mainCategory)
                @foreach ($mainCategory->healthCareCategories as $healthCareCategory)
                    <div id="tab-content-{{ $healthCareCategory->id }}" role="tabpanel"
                         aria-labelledby="tab-{{ $healthCareCategory->id }}" class="{{ $loop->first ? '' : 'hidden' }}">
