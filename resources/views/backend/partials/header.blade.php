    ...
    <div class="header-right">
                            ...
                            @forelse (auth()->user()->unreadNotifications as $notification)
                                <li class="row flex">
                                    <a href="#">
                                        ...
                                        <img src="{{ asset('assets/backend/vendors/images/logo.png') }}"
                                            alt="" />
                                    ...
                                    <a class="float-right" href="{{ route('admin.markasread', $notification->id) }}"> <i
                                            class="icon-copy bi bi-x"></i></a>
                                </li>
                            @empty
                                <li>
                                    <p>
            ...
            <div class="dropdown">
                <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                    <span class="user-icon">
                        <img class="pt-3" src="{{ asset('assets/backend/vendors/images/logo.png') }}" height="100"
                            width="100" alt="" />
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                    <a class="dropdown-item" href="{{ route('admin.profile.edit') }}"><i class="dw dw-user1"></i>
                        Profile</a>
        ...
        <div class="github-link">
            <a href="https://github.com/dropways/deskapp" target="_blank"><img
                    src="{{ asset('assets/backend/vendors/images/github.svg') }}" alt="" /></a>
        </div>
    </div>
</div>
